...
class Game():
    ...
    def __init__(self,
                 ...
                 on_main_phase_started:Callable[[Player],None]=None,
                 on_climax_phase_started:Callable[[Player],None]=None,
                 on_attack_phase_started:Callable[[Player],None]=None,
                 on_end_phase_started:Callable[[Player],None]=None,
                 on_ad_as_entered:Callable[[Player],None]=None,
                 on_trigger_as_entered:Callable[[Player],None]=None,
                 on_damage_as_entered:Callable[[Player],None]=None,
